#!/usr/bin/env python3
"""
Test script to run all ingestion services.
"""
import sys
import os
...
# from app.services.fir_narrative_service import ingest_fir_narratives  # This might be unstructured, skip for now
...
def main():
    ...
    try:
        print("\n4. Ingesting organization registry...")
